                ...
                <div className="max-w-4xl space-y-8">
                    <div className="space-y-3">
                        ...
                        <p className="text-sm leading-7 text-muted-foreground">
                            <strong>Effective date:</strong> 30 April 2026 · <strong>Last updated:</strong> 30 April 2026
                        </p>
                    </div>
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">Overview</h2>
                        <p className="leading-7 text-muted-foreground">
                            This Privacy Policy explains how Social Poster ("Social Poster", "we", "us", or "our") collects, uses, stores, shares,
                            retains, and deletes information when you use our application available at{' '}
                            <a
                            ...
                            (the "Service"). It also explains how Social Poster&apos;s use and transfer of information received from Google APIs adheres to
                            the{' '}
                            <a
                    ...
                    <section className="space-y-3">
                        ...
                        <h3 className="text-lg font-semibold">1.1 Account information</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-4">1.2 Google user data accessed via Google APIs</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            <li>
                                <code>https://www.googleapis.com/auth/spreadsheets.readonly</code> — read-only access to Google Sheets you choose to connect.
                            </li>
                            <li>
                                <code>https://www.googleapis.com/auth/userinfo.email</code> and <code>https://www.googleapis.com/auth/userinfo.profile</code> — to identify you in our system.
                            </li>
                        </ul>
                        <p className="leading-7 text-muted-foreground">When you connect a specific Google Sheets spreadsheet, we read:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-4">1.3 Information you provide directly</h3>
                        <p className="leading-7 text-muted-foreground">You may provide the following information when configuring Social Poster:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            <li>Connection credentials and metadata for third-party social media platforms you choose to connect (for example, account IDs and OAuth tokens for X/Twitter, LinkedIn, Facebook, Instagram, etc.).</li>
                        ...
                        <h3 className="text-lg font-semibold pt-4">1.4 Automatically collected information</h3>
                        <p className="leading-7 text-muted-foreground">When you use the Service we automatically collect a limited set of operational information:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="leading-7 text-muted-foreground">We use the information described above strictly for the following purposes:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            <li><strong>Authenticate you</strong> and maintain your session within Social Poster.</li>
                            <li><strong>Read content from spreadsheets you have connected</strong> so that you can schedule and publish that content to social media platforms you have separately authorized.</li>
                            <li><strong>Schedule and publish posts</strong> on your behalf to the social media accounts you have connected.</li>
                            <li><strong>Operate, maintain, and secure the Service</strong>, including diagnosing errors, preventing abuse, and protecting against unauthorized access.</li>
                            <li><strong>Communicate with you</strong> about service-related matters (for example, OAuth re-authentication prompts, scheduling failures, and important account notices).</li>
                        </ul>
                        <p className="leading-7 text-muted-foreground">
                            We do <strong>not</strong> use Google user data for advertising, profiling unrelated to the Service, or any purpose outside the features described here.
                        </p>
                        <p className="leading-7 text-muted-foreground">
                            We do <strong>not</strong> use Google user data to develop, improve, or train generalized or non-personalized AI/ML models. Any automated processing of your spreadsheet content (for example, formatting a row into a post draft) happens only in the context of fulfilling your direct, in-app request.
                        </p>
                    </section>

                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">3. How We Share Information</h2>
                        <p className="leading-7 text-muted-foreground">Social Poster shares information only as described below. We do not sell personal information to third parties.</p>

                        <h3 className="text-lg font-semibold pt-2">3.1 Social media platforms you connect</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-2">3.2 Service providers (sub-processors)</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-2">3.3 Legal and safety</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-2">3.4 Business transfers</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-2">3.5 Limited Use disclosure (Google API Services)</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            ...
                            <li>Is <strong>not</strong> transferred to third parties except as necessary to provide or improve those features, to comply with applicable law, or as part of a merger, acquisition, or sale of assets.</li>
                            <li>Is <strong>not</strong> used for serving advertisements.</li>
                            <li>Is <strong>not</strong> read by humans except (a) with your explicit consent for specific messages, (b) when necessary for security purposes such as investigating abuse, (c) to comply with applicable law, or (d) when the data has been aggregated and anonymized for internal operational reporting.</li>
                            <li>Is <strong>not</strong> used to develop, improve, or train generalized or non-personalized AI/ML models.</li>
                        </ul>
                    </section>

                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">4. How We Store and Protect Your Information</h2>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            <li><strong>Encryption in transit.</strong> All traffic between your browser and Social Poster is served over HTTPS/TLS. All calls to Google APIs and to social media platform APIs are made over TLS.</li>
                            <li><strong>Encryption at rest.</strong> Data stored in our managed database is encrypted at rest by our infrastructure providers (Supabase / underlying cloud provider).</li>
                            <li><strong>Access controls.</strong> Production database access is restricted to a small number of named administrators using strong authentication. OAuth tokens are stored in restricted-access tables and are never exposed to the client-side application.</li>
                            <li><strong>Token handling.</strong> Google OAuth refresh and access tokens are stored encrypted in our database and are used only by server-side processes to call Google APIs on your behalf. Access tokens are short-lived and refreshed only when needed to fulfill your scheduled actions.</li>
                            <li><strong>Network controls.</strong> Database connections require authenticated, TLS-protected sessions. Row-level security is enabled on user-scoped tables so that one user&apos;s data cannot be queried by another.</li>
                            <li><strong>Operational security.</strong> We monitor application logs for anomalies and errors. We promptly patch and update dependencies.</li>
                        </ul>
                        <p className="leading-7 text-muted-foreground">
                    ...
                    <section className="space-y-3">
                        <h2 className="text-2xl font-semibold">5. Data Retention and Deletion</h2>

                        <h3 className="text-lg font-semibold">5.1 Retention</h3>
                        <p className="leading-7 text-muted-foreground">
                        ...
                        <h3 className="text-lg font-semibold pt-2">5.3 Account deletion and data deletion requests</h3>
                        <p className="leading-7 text-muted-foreground">You can request deletion of your Social Poster account and all associated data at any time by:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            <li>Using the <strong>Delete my account</strong> option in the in-app Settings page; <strong>or</strong></li>
                            <li>Emailing <a href="mailto:daniel.shulman@gmail.com" className="underline underline-offset-4">daniel.shulman@gmail.com</a> from the email address associated with your account with the subject &quot;Delete my account&quot;.</li>
                        </ul>
                        <p className="leading-7 text-muted-foreground">When you delete your account, we will:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
                            ...
                            <li>Complete deletion within 30 days of the request, except where retention is required by law (for example, audit logs of authentication events may be retained for a limited period for security and legal-compliance purposes).</li>
                        </ul>

                        <h3 className="text-lg font-semibold pt-2">5.4 Backups</h3>
                        <p className="leading-7 text-muted-foreground">
                    ...
                    <section className="space-y-3">
                        ...
                        <p className="leading-7 text-muted-foreground">Depending on where you live, you may have the right to:</p>
                        <ul className="list-disc list-inside leading-7 text-muted-foreground">
