...
export async function GET(req: Request) {
    ...
    // Instagram Login flow - uses instagram_business_basic and instagram_business_content_publish
    // These scopes are ONLY valid for Instagram Login (not Facebook Login)
    ...
    console.log('Instagram OAuth redirect:', authUrl.toString());
