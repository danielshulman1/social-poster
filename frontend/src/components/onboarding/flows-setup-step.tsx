    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50 p-4">
      <div className="w-full max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-purple-50 to-pink-50 border border-purple-200 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-4">What Are Content Flows?</h2>
          ...
          <div className="grid md:grid-cols-3 gap-4">
            <div className="bg-white rounded-lg p-4 border border-purple-200">
              ...
              <h3 className="font-semibold text-gray-900 mb-2">Scheduled</h3>
        ...
        <div className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">Example Flows</h2>
              ...
              >
                ...
                {expandedFlow === idx && (
                  <div className="mt-6 pt-6 border-t border-gray-200">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-3">What you'd set up:</h4>
        ...
        {/* Customization */}
        <div className="bg-white rounded-lg border border-gray-200 p-8 mb-8">
          <h2 className="text-2xl font-bold text-gray-900 mb-6">How to Customize Your Flows</h2>
          <p className="text-gray-600 mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            {PERSONALIZATION_OPTIONS.map((option, idx) => (
              <div key={idx} className="flex gap-4">
                <div className="flex-shrink-0 w-10 h-10 bg-blue-100 text-blue-700 rounded-full flex items-center justify-center font-semibold">
                  {idx + 1}
                </div>
                <div>
        ...
        <div className="bg-green-50 border border-green-200 rounded-lg p-8 mb-8">
          <h2 className="text-2xl font-bold text-green-900 mb-4">Your First Flow</h2>
        ...
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-8 mb-8">
          <h3 className="text-xl font-bold text-blue-900 mb-4">Benefits of Using Flows</h3>
